...
const Calendar = ({ startDayOfWeek = 0 }: CalendarProps) => {
  ...
  return (
    <div className="p-2 bg-white dark:bg-white dark:bg-opacity-5 shadow-md rounded-lg max-w-[200px] sm:max-w-[240px]">
      {/* Month & Year Header with Navigation */}
      <div className="flex justify-between items-center mb-1">
        <Button intent="icon" onClick={() => changeMonth(-1)}>
          <Icon size="S" className="light:text-black dark:text-white">
            <ChevronLeftIcon />
          </Icon>
        </Button>
