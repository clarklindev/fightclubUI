...
export const Heading: React.FC<HeadingProps> = ({ variation, size, className, children }) => {
  ...
  return (
    <Component as={variation} size={size ? HeadingSize[size] : undefined} className={className}>
      {children}
    </Component>
  );
};
